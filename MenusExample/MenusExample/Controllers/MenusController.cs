...
using MenusExample.Models;

namespace MenusExample.Controllers
{
    public class MenusController : Controller
    {
        private MenusDatabaseContext db = new MenusDatabaseContext();
